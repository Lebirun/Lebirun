...
#define DPRINTF1(fmt, ...) do { if (debugMode && debugLevel >= 1) printf(fmt, ##__VA_ARGS__); } while (0)
#define DPRINTF2(fmt, ...) do { if (debugMode && debugLevel >= 2) printf(fmt, ##__VA_ARGS__); } while (0)
#define DPRINTF3(fmt, ...) do { if (debugMode && debugLevel >= 3) printf(fmt, ##__VA_ARGS__); } while (0)
#define DPRINTF4(fmt, ...) do { if (debugMode && debugLevel >= 4) printf(fmt, ##__VA_ARGS__); } while (0)
#define DPRINTF5(fmt, ...) do { if (debugMode && debugLevel >= 5) printf(fmt, ##__VA_ARGS__); } while (0)
