...
static volatile uint32_t wdt_last_kick = 0;
static volatile uint32_t wdt_last_sched_tick = 0;
static volatile uint32_t wdt_prev_tick_count = 0;
static volatile uint32_t wdt_stall_strikes = 0;
...
static void watchdog_callback(uint32_t ticks) {
    task_t *t;
    uint32_t elapsed;
    int limit;
    (void)ticks;
