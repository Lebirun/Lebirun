...
static volatile uint32_t sysfs_dirent_index;
...
static uint32_t sysfs_read_static(vfs_node_t *node, uint32_t offset, uint32_t size, uint8_t *buffer, const char *content, uint32_t content_len) {
    uint32_t remaining;
...
static dirent_t *sysfs_cpufreq_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
...
static dirent_t *sysfs_topology_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
    static const char *names[] = {
...
static dirent_t *sysfs_cpu0_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
...
static dirent_t *sysfs_cpu_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
...
static dirent_t *sysfs_system_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
...
static dirent_t *sysfs_devices_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
...
static dirent_t *sysfs_empty_readdir(vfs_node_t *node, uint32_t index) {
    (void)node;
    (void)index;
    return NULL;
}
...
static dirent_t *sysfs_class_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
...
static dirent_t *sysfs_kernel_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
...
static dirent_t *sysfs_kernel_mm_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
...
static dirent_t *sysfs_root_readdir(vfs_node_t *node, uint32_t index) {
    dirent_t *d;
    static const char *names[] = {
        "devices", "class", "block", "kernel", "fs", "bus"
    };
    static const uint32_t inodes[] = { 10, 11, 12, 13, 14, 15 };
...
static void sysfs_init_node(vfs_node_t *n, const char *name, uint32_t flags, vfs_node_t *parent) {
