...
static void KERNEL_INIT kernel_reclaim_memory(
    uint8_t *section_start, uint8_t *section_end, int flush_cpus,
    int report) {
    uint64_t start;
    uint64_t end;
    uint64_t address;
...
static void KERNEL_INIT kernel_reclaim_early_init_memory(void) {
