...
This is a small project that i made since im really interested in doing OSDev. This is the successor to Lebirun C (Lebirun but made in C, rather than being made in a C# Library called Cosmos). Note that this is still called Lebirun in the code.
