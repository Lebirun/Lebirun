...
(*.[0-9]*)
	...
	if test ! -f "/home/opuayt/leb/userprog/ncurses-6.6/man_alias.sed" ; then
cat >>/home/opuayt/leb/userprog/ncurses-6.6/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/opuayt/leb/userprog/ncurses-6.6/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$cf_full_alias" |sed -f "/home/opuayt/leb/userprog/ncurses-6.6/man_alias.sed" | sort -u; test "$cf_part_alias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/opuayt/leb/userprog/ncurses-6.6/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/opuayt/leb/userprog/ncurses-6.6/man_alias.sed" \
		< "$i" | sed -f /home/opuayt/leb/userprog/ncurses-6.6/edit_man.sed >$TMP
