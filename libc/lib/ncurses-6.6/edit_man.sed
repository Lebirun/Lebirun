# This script was generated from '/home/opuayt/leb/libc/lib/ncurses-6.6/man/man_db.renames' by man/make_sed.sh.
# Do the TH lines
...
s/\<fB\(\\%\)\?adacursesw6-config\\fP(1)/fB\1adacursesw6-config\\fP(1)/
s/\<fB\(\\%\)\?ncursesw6-config\\fP(1)/fB\1ncursesw6-config\\fP(1)/
